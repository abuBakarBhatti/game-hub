    ...
    <List>
        ...
        <ListItem key={genre.id} paddingY="5px" >
          <HStack>
            ...
            <Button whiteSpace="normal" textAlign="left" fontWeight={ selectedGenre1?.id === genre.id ?  'bold' : 'normal' } variant="link" fontSize="lg" onClick={() => onSelectGenre(genre)}>{genre.name}</Button>
          </HStack>
        </ListItem>)}
    </List>
    </>
